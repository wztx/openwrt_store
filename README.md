# store
此项目用于存储 [自用AutoImmortalWrt](https://github.com/wztx/AutoImmortalWrt/) 仓库以外的第三方软件包
...
| luci-app-quickstart | iStore首页和网络向导 | [linkease/luci-app-quickstart](https://github.com/kiddin9/op-packages/tree/main/luci-app-quickstart) |
...
| luci-app-passwall2 | 代理工具 | [xiaorouji/openwrt-passwall2](https://github.com/xiaorouji/openwrt-passwall2) [Openwrt-Passwall/openwrt-passwall2](https://github.com/Openwrt-Passwall/openwrt-passwall2)|
...
| luci-app-lucky | Lucky大吉,软硬路由公网神器,ipv6/ipv4 端口转发,反向代理 | [程序 gdy666/lucky](https://github.com/gdy666/luci-app-lucky) [ipk仓库](https://github.com/sirpdboy/luci-app-lucky/releases) |
| luci-app-gecoosac | 集客AC | [laipeng668/luci-app-gecoosac](https://github.com/laipeng668/luci-app-gecoosac) |
...
| luci-theme-aurorz | 极光主题 | [eamonxg/luci-theme-aurora](https://github.com/eamonxg/luci-theme-aurora) |
...
| dufs | 静态文件服务器DUFS | [sigoden/dufs](https://github.com/sigoden/dufs) |
...
| luci-app-openlist2 | 多存储文件程序 | [sbwml/luci-app-openlist2](https://github.com/sbwml/luci-app-openlist2) |
| luci-app-cloudflare-ip | OpenWrt Cloudflare IP 优选工具 | [hello-yunshu/use-cloudflare-ip](https://github.com/hello-yunshu/use-cloudflare-ip) |
| luci-app-run | run安装器 | [wukongdaily/luci-app-run](https://github.com/wukongdaily/luci-app-run) |
