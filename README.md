# store
此项目用于存储 [自用AutoImmortalWrt](https://github.com/wztx/AutoImmortalWrt/) 24.10仓库以外的第三方软件包


| 软件名称 | 简介 / 功能描述 | 来源 / 项目地址 |
| --------------------- | -------------------------------- | ----------------------------------------------------------------------------------- |
| luci-app-amlogic | 晶晨宝盒(仅限ARM-64平台) | [luci-app-amlogic](https://github.com/ophub/luci-app-amlogic) |
| luci-app-store | iStore应用商店 | [luci-app-store](https://repo.istoreos.com/repo/all/store/) |
| luci-app-run | run安装器 | [luci-app-run](https://github.com/wukongdaily/luci-app-run) |
...
| luci-app-passwall | 代理工具 | [openwrt-passwall](https://github.com/Openwrt-Passwall/openwrt-passwall) [package](https://sourceforge.net/projects/openwrt-passwall-build/files/releases/) |
...
| luci-app-tailscale-community | Tailscale (Community) | [luci-app-tailscale-community](https://github.com/Tokisaki-Galaxy/luci-app-tailscale-community) |
| luci-app-gecoosac | 集客AC | [luci-app-gecoosac](https://github.com/laipeng668/luci-app-gecoosac) |
| luci-app-bandix | 网络流量监控 | [luci-app-bandix](https://github.com/timsaya/luci-app-bandix) [bandix](https://github.com/timsaya/openwrt-bandix) |
| luci-app-rtp2httpd | IPTV 流媒体转发服务器 | [rtp2httpd](https://github.com/stackia/rtp2httpd) |
| luci-app-dufs | 静态文件服务器DUFS | [luci-app-dufs](https://github.com/zouzonghao/luci-app-dufs) |
| luci-app-openlist2 | 多存储文件程序 | [luci-app-openlist2](https://github.com/sbwml/luci-app-openlist2) |
| luci-app-cloudflare-ip | Cloudflare IP 优选工具 | [use-cloudflare-ip](https://github.com/hello-yunshu/use-cloudflare-ip) |

## 如何集成到AutoBuildImmortalWrt
https://github.com/wukongdaily/AutoBuildImmortalWrt/discussions/209
## ❤️其它GitHub Action项目推荐🌟 （建议收藏）⬇️
- ### [一键生成run插件] 🆕
- https://github.com/wkccd/CloudRunFilesBuilder<br>
- ### [一键生成docker离线镜像] 🆕
